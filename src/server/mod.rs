...
// To bind unix socket to IP Address
// socat TCP-LISTEN:8080,bind=0.0.0.0,reuseaddr,fork UNIX-CONNECT:/run/kvmd/ustreamer.sock


pub async fn start_axum(port: u32, shared: Arc<RwLock<ImageData>>) {
